...
## Search the Portrait Database (Pdb)
...
Search the Pdb by defining a search string using specific demographic and psychographic criteria.  The search syntax is based on <a href="https://lucene.apache.org/core/2_9_4/queryparsersyntax.html">Lucene</a>
